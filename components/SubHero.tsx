...
function SubHero(){
return <div className='subHero'>
        <div className='whySection'> <img src="photos/logo.webp" alt="logo" /> So Why Choose Glimmer Guard?</div>
        <p className='subHeroHeaderTextBox'>Authentic Tint Services</p>
        <div className='subHeroTextBox'>
          <p>
          At<span className='redText'> Glimmer Guard</span>, we specialize in precision-cut <span className='redText'>automotive 
          tint</span> made to fit your vehicle perfectly—no trimming, no hassle. Based in <span className='redText'>Texas </span> and founded by an 
